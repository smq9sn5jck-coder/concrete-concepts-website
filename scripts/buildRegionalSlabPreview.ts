...
const productionDefaults = {
  ...
  VITE_REGIONAL_SLAB_PREVIEW: "false",
  VITE_REGIONAL_SLAB_PUBLISHED: "false",
};

try {
  run("pnpm", ["run", "build"], {
    ...productionDefaults,
    VITE_OTHER_TRADE_PREVIEW: "true",
    VITE_GOLD_COAST_PREVIEW: "true",
    VITE_REGIONAL_SLAB_PREVIEW: "true",
  });
} finally {
  run("pnpm", ["regional-slab:generate"], productionDefaults);
