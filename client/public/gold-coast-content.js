...
export const GENERATED_GOLD_COAST_PREVIEW_ENABLED = false;
export const GENERATED_GOLD_COAST_PUBLISHED_ENABLED = false;
export const GENERATED_GOLD_COAST_OFFICIAL_RESOURCES = {
  "driveways": {
...
export const GENERATED_GOLD_COAST_EXISTING_LOCALITIES = [
  {
    "slug": "ormeau",
    "name": "Ormeau"
  },
...
export const GENERATED_GOLD_COAST_COVERAGE_GROUPS = [
  {
...
export const GENERATED_GOLD_COAST_SERVICE_PAGES = [
  {
    "slug": "driveways",
...
export const GENERATED_GOLD_COAST_UPGRADE_LOCALITIES = [
  {
    "sequence": 1,
    "slug": "coomera",
    "locality": "Coomera",
    ...
    "faqs": [
      {
        "question": "What helps with a Coomera driveway quote?",
        "answer": "Provide dimensions, the existing surface, grade changes, garage transition, current crossing, drainage points, street access and photos from the road to the work area."
      },
      {
        "question": "Can several post-build concrete areas be reviewed together?",
        "answer": "Yes. List each driveway, path, patio or slab area separately so access, level transitions, preparation and drainage can be considered as one coordinated enquiry."
      },
      {
        "question": "Does flood mapping decide the concrete scope?",
        "answer": "No. City mapping is a customer planning resource. The scope still depends on the actual property, measurements, levels, drainage design and any professional or approval requirements."
      }
    ],
    "regionalHub": {
  ...
  },
  {
    ...
    "localityContext": {
      ...
      "sourceUrls": [
        "https://www.goldcoast.qld.gov.au/Planning-building/Building-applications/Domestic-building-works/Minor-domestic-building-works/Retaining-walls"
      ]
    },
    "services": [
      {
    ...
    "faqs": [
      {
        "question": "What should be photographed on a sloping Nerang site?",
        "answer": "Include views from the street, all grade changes, drainage paths, boundaries, nearby structures and the narrowest point on the access route to the work area."
      },
      {
        "question": "Does CCG quote retaining walls over 1 metre here?",
        "answer": "No. This preview scope is limited to suitable residential walls up to 1 metre, and approval, engineering, siting, drainage and other site requirements can still apply below that height."
      },
      {
        "question": "Can the quote include excavation information?",
        "answer": "Yes. Describe existing ground, likely cut, spoil-removal access, underground services and any surfaces or landscaping that need protection during the proposed work."
      }
    ],
    "regionalHub": {
      "label": "Gold Coast service areas",
  ...
  },
  {
    ...
    "localityContext": {
      ...
      "sourceUrls": [
        "https://www.goldcoast.qld.gov.au/Planning-building/Development-applications/DA-types/Driveways-vehicular-crossings"
      ]
    },
    "services": [
      {
    ...
    "faqs": [
      {
        "question": "Is the driveway the same as the vehicular crossing?",
        "answer": "No. The City describes the driveway as the private-land section and the vehicular crossing as the public-land section between the boundary and road. Address-specific requirements should be checked."
      },
      {
        "question": "What information helps with an Ormeau slab enquiry?",
        "answer": "Include dimensions, intended structure or use, plans or manufacturer details, current ground, excavation needs, access, service locations, drainage and any available engineering information."
      },
      {
        "question": "Can CCG decide whether City approval is required?",
        "answer": "No. CCG can record the proposed scope, while the City's official resources and relevant professionals should be used for property-specific approval or design advice."
      }
    ],
    "regionalHub": {
      "label": "Gold Coast service areas",
  ...
  },
  {
    ...
    "localityContext": {
      ...
      "sourceUrls": [
        "https://www.goldcoast.qld.gov.au/Planning-building/Flood-maps",
        "https://www.goldcoast.qld.gov.au/Planning-building/Building-applications/Stormwater-and-sediment-control-on-building-sites"
      ]
    },
    "services": [
      {
    ...
    "faqs": [
      {
        "question": "What helps with a Robina pool-surround enquiry?",
        "answer": "Provide dimensions, pool coping and equipment details, drainage points, expected wet use, finish preference, access measurements and photos of every connected surface."
      },
      {
        "question": "Can established landscaping affect the concrete scope?",
        "answer": "Yes. Gates, gardens, walls and finished surfaces can change excavation and placement options, so the entire access route should be measured and photographed."
      },
      {
        "question": "Are City resources the same as approval advice?",
        "answer": "No. They are official customer resources for further checking. Approval, engineering, drainage and site requirements should be confirmed for the actual property with the relevant authority or professional."
      }
    ],
    "regionalHub": {
      "label": "Gold Coast service areas",
...
export const GENERATED_GOLD_COAST_REVIEW_PATHS = [
  "/gold-coast-review",
  "/areas/gold-coast",
...
export const GENERATED_GOLD_COAST_STRUCTURED_DATA_BY_SLUG = {
  "coomera": [
    {
      ...
      "itemListElement": [
        ...
        },
        {
          ...
          "position": 2,
          "name": "Coomera",
          "item": "https://concreteconceptsgroup.com/areas/coomera"
        }
      ]
    },
    {
      "@context": "https://schema.org",
      "@type": "Service",
      "name": "Residential concreting in Coomera",
      "serviceType": [
        "Concrete driveways",
        "Concrete slabs",
    ...
    },
    {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "What helps with a Coomera driveway quote?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Provide dimensions, the existing surface, grade changes, garage transition, current crossing, drainage points, street access and photos from the road to the work area."
          }
        },
        {
          "@type": "Question",
          "name": "Can several post-build concrete areas be reviewed together?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes. List each driveway, path, patio or slab area separately so access, level transitions, preparation and drainage can be considered as one coordinated enquiry."
          }
        },
        {
          "@type": "Question",
          "name": "Does flood mapping decide the concrete scope?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "No. City mapping is a customer planning resource. The scope still depends on the actual property, measurements, levels, drainage design and any professional or approval requirements."
          }
        }
      ]
    }
  ...
  "nerang": [
    {
      ...
      "itemListElement": [
        ...
        },
        {
          ...
          "position": 2,
          "name": "Nerang",
          "item": "https://concreteconceptsgroup.com/areas/nerang"
        }
      ]
    },
    {
      "@context": "https://schema.org",
      "@type": "Service",
      "name": "Residential concreting in Nerang",
      "serviceType": [
        "Concrete driveways",
        "Small retaining walls",
        "Concrete slabs",
    ...
    },
    {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "What should be photographed on a sloping Nerang site?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Include views from the street, all grade changes, drainage paths, boundaries, nearby structures and the narrowest point on the access route to the work area."
          }
        },
        {
          "@type": "Question",
          "name": "Does CCG quote retaining walls over 1 metre here?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "No. This preview scope is limited to suitable residential walls up to 1 metre, and approval, engineering, siting, drainage and other site requirements can still apply below that height."
          }
        },
        {
          "@type": "Question",
          "name": "Can the quote include excavation information?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes. Describe existing ground, likely cut, spoil-removal access, underground services and any surfaces or landscaping that need protection during the proposed work."
          }
        }
      ]
    }
  ...
  "ormeau": [
    {
      ...
      "itemListElement": [
        ...
        },
        {
          ...
          "position": 2,
          "name": "Ormeau",
          "item": "https://concreteconceptsgroup.com/areas/ormeau"
        }
      ]
    },
    {
      "@context": "https://schema.org",
      "@type": "Service",
      "name": "Residential concreting in Ormeau",
      "serviceType": [
        "Concrete driveways",
        "Concrete slabs",
        "Patios and outdoor concrete",
    ...
    },
    {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "Is the driveway the same as the vehicular crossing?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "No. The City describes the driveway as the private-land section and the vehicular crossing as the public-land section between the boundary and road. Address-specific requirements should be checked."
          }
        },
        {
          "@type": "Question",
          "name": "What information helps with an Ormeau slab enquiry?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Include dimensions, intended structure or use, plans or manufacturer details, current ground, excavation needs, access, service locations, drainage and any available engineering information."
          }
        },
        {
          "@type": "Question",
          "name": "Can CCG decide whether City approval is required?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "No. CCG can record the proposed scope, while the City's official resources and relevant professionals should be used for property-specific approval or design advice."
          }
        }
      ]
    }
  ...
  "robina": [
    {
      ...
      "itemListElement": [
        ...
        },
        {
          ...
          "position": 2,
          "name": "Robina",
          "item": "https://concreteconceptsgroup.com/areas/robina"
        }
      ]
    },
    {
      "@context": "https://schema.org",
      "@type": "Service",
      "name": "Residential concreting in Robina",
      "serviceType": [
        "Patios and outdoor concrete",
        "Pool surrounds",
        "Concrete driveways",
    ...
    },
    {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "What helps with a Robina pool-surround enquiry?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Provide dimensions, pool coping and equipment details, drainage points, expected wet use, finish preference, access measurements and photos of every connected surface."
          }
        },
        {
          "@type": "Question",
          "name": "Can established landscaping affect the concrete scope?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes. Gates, gardens, walls and finished surfaces can change excavation and placement options, so the entire access route should be measured and photographed."
          }
        },
        {
          "@type": "Question",
          "name": "Are City resources the same as approval advice?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "No. They are official customer resources for further checking. Approval, engineering, drainage and site requirements should be confirmed for the actual property with the relevant authority or professional."
          }
        }
      ]
    }
