...
import { ArrowRight, CheckCircle, Shield, Phone, Star, MapPin, Clock, Ruler, HelpCircle, BookOpen, Quote } from "lucide-react";
...
const SERVICE_REVIEWS: Record<string, { name: string; location: string; text: string; source: string }[]> = {
  ...
  "exposed-aggregate-brisbane": [
    { name: "Myresh M", location: "Mount Gravatt East", text: "Fantastic work from Jarrad and his team! Professional, efficient and delivered a high quality exposed aggregate finish. Very happy with the result and highly recommend!!", source: "HiPages" },
    { name: "Helen K", location: "Geebung", text: "Connected with Concrete Concepts Group and would recommend them.", source: "HiPages" },
    { name: "Jenny F", location: "Brisbane", text: "Jarrad quoted our job quickly and started within the week. The exposed aggregate driveway looks beautiful. Very happy we chose Concrete Concepts Group!", source: "Google" },
  ],
  "retaining-walls-brisbane": [
    { name: "Amanda R", location: "Brisbane", text: "Concrete Concepts Group did our entire backyard — patio, paths and retaining wall. Jarrad was easy to deal with, gave honest advice and delivered exactly what was promised.", source: "Google" },
  ...
  "concrete-patios-brisbane": [
    { name: "Sarah T", location: "Brisbane", text: "We had our patio and pool surround done by Concrete Concepts Group. The exposed aggregate finish looks incredible. Highly recommend!", source: "Google" },
    { name: "Amanda R", location: "Brisbane", text: "Concrete Concepts Group did our entire backyard — patio, paths and retaining wall. Jarrad was easy to deal with, gave honest advice and delivered exactly what was promised.", source: "Google" },
  ...
  "pool-surrounds-brisbane": [
    { name: "Sarah T", location: "Brisbane", text: "We had our patio and pool surround done by Concrete Concepts Group. The exposed aggregate finish looks incredible. Highly recommend!", source: "Google" },
    { name: "Mark D", location: "Brisbane", text: "Second time using Concrete Concepts Group — first for our driveway, now for the pool surround. Consistently excellent work.", source: "Google" },
    { name: "Priya N", location: "Brisbane", text: "We got quotes from 5 different concreters and Jarrad was the most professional and fairly priced. The finished product is stunning!", source: "Google" },
  ],
  "shed-slabs-brisbane": [
    { name: "Michael B", location: "Brisbane", text: "Great team, great work. Had a large slab poured for our shed and the boys were efficient and professional. Price was fair and the finish was perfect.", source: "Google" },
...
const SERVICES: Record<string, ServiceData> = {
  "concrete-driveways-brisbane": {
    ...
    metaTitle: "Concrete Driveways Brisbane | | Free Quotes | Concrete Concepts Group",
    metaDescription: "Professional concrete driveway installation in Brisbane. Exposed aggregate, coloured and plain concrete driveways, scoped to your site. QBCC Licensed #15299707. Detailed quotes available. Call 0424 463 268.",
    ...
    pricingIntro: "Every project is measured and scoped individually. Your detailed quote confirms the finish, access, excavation, disposal, drainage, pumping, reinforcement, and final measure before work is scheduled.",
    pricingTable: [
      { type: "Plain Concrete", range: "Site-specific quote", est50: "Detailed scope", notes: "Standard grey, broom or trowel finish" },
      { type: "Coloured Concrete", range: "Site-specific quote", est50: "Detailed scope", notes: "Oxide pigments, range of earth tones" },
      { type: "Exposed Aggregate", range: "Site-specific quote", est50: "Detailed scope", notes: "Premium stone blends, sealed" },
      { type: "Stencilled / Stamped", range: "Site-specific quote", est50: "Detailed scope", notes: "Pattern replicating pavers/stone" },
      { type: "Covercrete Overlay", range: "Site-specific quote", est50: "Detailed scope", notes: "Resurfacing existing concrete" },
    ],
    pricingNotes: "A detailed quote is prepared after we verify the final measure, chosen finish, access, excavation, disposal, drainage, pumping, thickness, reinforcement, engineering and any approvals required.",
    comparison: {
      headers: ["Feature", "Concrete Driveway", "Paver Driveway", "Asphalt Driveway"],
      rows: [
        { feature: "Quote planning", values: ["Scope and finish verified", "Scope and finish verified", "Scope and finish verified"] },
    ...
    faqs: [
      { q: "How much does a concrete driveway cost in Brisbane?", a: "The price for a concrete driveway in Brisbane is confirmed only after we verify the scope on site. Your detailed quote accounts for the finish, final measure, access, excavation, disposal, drainage, pumping, required thickness and reinforcement. Submit the detailed quote form for an itemised written quote." },
      ...
      { q: "Can you replace my existing driveway?", a: "Yes. We handle the full process: demolition of old concrete, excavation, sub-base preparation and installation of the new driveway. Old materials are taken to approved disposal facilities. Your detailed quote confirms the removal scope after we verify thickness, access, disposal requirements and the final measure." },
      ...
      { q: "Concrete vs pavers — which is better for a driveway?", a: "Both have advantages. Concrete provides a continuous, low-maintenance surface that does not shift or settle between units, while pavers allow individual replacement if damaged. The better choice depends on your site, preferred finish, drainage and maintenance expectations; we can discuss both during the detailed quote process." },
    ],
  ...
  "exposed-aggregate-brisbane": {
    ...
    metaTitle: "Exposed Aggregate Brisbane | Premium Stone Finishes | | Concrete Concepts Group",
    metaDescription: "Beautiful exposed aggregate concrete in Brisbane. Wide range of stone blends for driveways, patios and pool surrounds. QBCC Licensed. Detailed quotes available. Call 0424 463 268.",
    ...
    pricingIntro: "Every project is measured and scoped individually. Your detailed quote confirms the finish, access, excavation, disposal, drainage, pumping, reinforcement, and final measure before work is scheduled.",
    pricingTable: [
      { type: "Standard Blend", range: "Site-specific quote", est50: "Detailed scope", notes: "Popular Canberra or Goulburn mix" },
      { type: "Premium Blend", range: "Site-specific quote", est50: "Detailed scope", notes: "Multi-colour or custom stone mix" },
      { type: "Designer Blend", range: "Site-specific quote", est50: "Detailed scope", notes: "Rare stones, specialty finishes" },
      { type: "Exposed + Coloured Border", range: "Site-specific quote", est50: "Detailed scope", notes: "Two-tone with coloured concrete border" },
    ],
    pricingNotes: "A detailed quote is prepared after we verify the final measure, chosen finish, access, excavation, disposal, drainage, pumping, thickness, reinforcement, engineering and any approvals required.",
    comparison: {
    ...
    faqs: [
      ...
      { q: "How much does exposed aggregate cost in Brisbane?", a: "The price for an exposed aggregate project in Brisbane is confirmed only after we verify the scope on site. Your detailed quote accounts for the finish, final measure, access, excavation, disposal, drainage, pumping, required thickness and reinforcement. Submit the detailed quote form for an itemised written quote." },
  ...
  "retaining-walls-brisbane": {
    ...
    metaTitle: "Retaining Walls Brisbane | Concrete & Sleeper Walls | | Concrete Concepts Group",
    ...
    pricingIntro: "Every project is measured and scoped individually. Your detailed quote confirms the finish, access, excavation, disposal, drainage, pumping, reinforcement, and final measure before work is scheduled.",
    pricingTable: [
      { type: "Timber Sleeper (under 1m)", range: "Site-specific quote", est50: "Detailed scope", notes: "Garden terracing, low walls" },
      { type: "Concrete Block (under 1m)", range: "Site-specific quote", est50: "Detailed scope", notes: "Structural, no engineering needed" },
      { type: "Concrete Block (1-2m)", range: "Site-specific quote", est50: "Detailed scope", notes: "Engineered, council approved" },
      { type: "Poured Concrete (1-2m)", range: "Site-specific quote", est50: "Detailed scope", notes: "Maximum strength, engineered" },
      { type: "Poured Concrete (2m+)", range: "Site-specific quote", est50: "Detailed scope", notes: "Heavy-duty, full engineering" },
    ],
    pricingNotes: "A detailed quote is prepared after we verify the final measure, chosen finish, access, excavation, disposal, drainage, pumping, thickness, reinforcement, engineering and any approvals required.",
    faqs: [
      ...
      { q: "How much does a retaining wall cost in Brisbane?", a: "The price for a retaining wall in Brisbane is confirmed only after we verify the scope on site. Your detailed quote accounts for the finish, final measure, access, excavation, disposal, drainage, pumping, required thickness and reinforcement. Submit the detailed quote form for an itemised written quote." },
  ...
  "concrete-slabs-brisbane": {
    ...
    metaTitle: "Concrete Slabs Brisbane | House Slabs & Shed Slabs | | Concrete Concepts Group",
    metaDescription: "Professional concrete slab installation in Brisbane. House slabs, shed slabs, garage floors and commercial foundations, scoped to verified site and engineering requirements. QBCC Licensed. Detailed quotes available. Call 0424 463 268.",
    ...
    pricingIntro: "Every project is measured and scoped individually. Your detailed quote confirms the finish, access, excavation, disposal, drainage, pumping, reinforcement, and final measure before work is scheduled.",
    pricingTable: [
      { type: "Shed Slab (100mm)", range: "Site-specific quote", est50: "Detailed scope", notes: "Standard shed/garage floor" },
      { type: "Shed Slab (150mm heavy-duty)", range: "Site-specific quote", est50: "Detailed scope", notes: "Workshop, heavy vehicles" },
      { type: "House Slab (raft/waffle pod)", range: "Site-specific quote", est50: "Detailed scope", notes: "Engineered, Class A-H2 soils" },
      { type: "Commercial Slab", range: "Site-specific quote", est50: "Detailed scope", notes: "Heavy-duty, post-tensioned options" },
    ],
    pricingNotes: "A detailed quote is prepared after we verify the final measure, chosen finish, access, excavation, disposal, drainage, pumping, thickness, reinforcement, engineering and any approvals required.",
    faqs: [
      { q: "How much does a concrete slab cost in Brisbane?", a: "The price for a concrete slab in Brisbane is confirmed only after we verify the scope on site. Your detailed quote accounts for the finish, final measure, access, excavation, disposal, drainage, pumping, required thickness and reinforcement. Submit the detailed quote form for an itemised written quote." },
  ...
  "concrete-patios-brisbane": {
    ...
    metaTitle: "Concrete Patios Brisbane | Outdoor Entertaining Areas | | Concrete Concepts Group",
    metaDescription: "Transform your backyard with a premium concrete patio in Brisbane. Exposed aggregate, coloured and plain finishes, planned around your site and intended use. Detailed quotes available. Call 0424 463 268.",
    ...
    pricingIntro: "Every project is measured and scoped individually. Your detailed quote confirms the finish, access, excavation, disposal, drainage, pumping, reinforcement, and final measure before work is scheduled.",
    pricingTable: [
      { type: "Plain Concrete (broom finish)", range: "Site-specific quote", est50: "Detailed scope", notes: "Cost-effective, good grip" },
      { type: "Coloured Concrete", range: "Site-specific quote", est50: "Detailed scope", notes: "Wide colour range" },
      { type: "Exposed Aggregate", range: "Site-specific quote", est50: "Detailed scope", notes: "Most popular for patios" },
      { type: "Stencilled / Stamped", range: "Site-specific quote", est50: "Detailed scope", notes: "Paver/stone look" },
    ],
    pricingNotes: "A detailed quote is prepared after we verify the final measure, chosen finish, access, excavation, disposal, drainage, pumping, thickness, reinforcement, engineering and any approvals required.",
    faqs: [
      { q: "How much does a concrete patio cost in Brisbane?", a: "The price for a concrete patio in Brisbane is confirmed only after we verify the scope on site. Your detailed quote accounts for the finish, final measure, access, excavation, disposal, drainage, pumping, required thickness and reinforcement. Submit the detailed quote form for an itemised written quote." },
      ...
      { q: "Will a patio add value to my home?", a: "A well-designed outdoor entertaining area can improve the usability, presentation and perceived value of a Brisbane home. The strongest outcome comes from a patio that suits the property, connects well to the house and manages drainage correctly. We can discuss the appropriate finish and scope in your detailed quote." },
  ...
  "excavation-brisbane": {
    ...
    metaTitle: "Excavation Brisbane | Site Prep & Earthworks | Concrete Concepts Group",
    ...
    pricingIntro: "Every project is measured and scoped individually. Your detailed quote confirms the finish, access, excavation, disposal, drainage, pumping, reinforcement, and final measure before work is scheduled.",
    pricingTable: [
      { type: "Driveway excavation", range: "Site-specific quote", est50: "Detailed scope", notes: "150-200mm depth, standard access" },
      { type: "Slab site preparation", range: "Site-specific quote", est50: "Detailed scope", notes: "Level site, standard soil" },
      { type: "Old concrete removal", range: "Site-specific quote", est50: "Detailed scope", notes: "Includes demolition & disposal" },
      { type: "Retaining wall trench", range: "Site-specific quote", est50: "Detailed scope", notes: "Depth depends on wall height" },
      { type: "Tight access surcharge", range: "Site-specific quote", est50: "Detailed scope", notes: "Mini excavator required" },
    ],
    pricingNotes: "A detailed quote is prepared after we verify the final measure, chosen finish, access, excavation, disposal, drainage, pumping, thickness, reinforcement, engineering and any approvals required.",
    faqs: [
      { q: "How much does excavation cost in Brisbane?", a: "The price for excavation work in Brisbane is confirmed only after we verify the scope on site. Your detailed quote accounts for the finish, final measure, access, excavation, disposal, drainage, pumping, required thickness and reinforcement. Submit the detailed quote form for an itemised written quote." },
      ...
      { q: "Can you remove old concrete?", a: "Yes, we demolish and remove old concrete as part of our excavation service. We use hydraulic breakers, load material onto tippers and take it to approved recycling facilities. Your detailed quote confirms removal requirements after we verify thickness, access, disposal and the final measure." },
  ...
  "crossover-permits-brisbane": {
    ...
    metaTitle: "Crossover Permits Brisbane | Council-Approved Vehicle Crossings | Concrete Concepts Group",
    ...
    detailedContent: [
      ...
      "The permit process involves submitting a Vehicle Crossing Application to BCC, which includes a site plan showing the proposed crossover location, dimensions, and proximity to services (stormwater, power poles, trees). BCC typically processes applications within 10-15 business days. Council fees vary by crossover type and are confirmed during the application process.",
    ...
    pricingIntro: "Every project is measured and scoped individually. Your detailed quote confirms the finish, access, excavation, disposal, drainage, pumping, reinforcement, and final measure before work is scheduled.",
    pricingTable: [
      { type: "Single Crossover (3m wide)", range: "Site-specific quote", est50: "Detailed scope", notes: "Standard residential crossing" },
      { type: "Double Crossover (5-6m wide)", range: "Site-specific quote", est50: "Detailed scope", notes: "For double garages or wider access" },
      { type: "Old Crossover Removal", range: "Site-specific quote", est50: "Detailed scope", notes: "Includes kerb reinstatement" },
      { type: "Council Permit Fee", range: "Site-specific quote", est50: "Detailed scope", notes: "Paid to BCC, varies by type" },
    ],
    pricingNotes: "A detailed quote is prepared after we verify the final measure, chosen finish, access, excavation, disposal, drainage, pumping, thickness, reinforcement, engineering and any approvals required.",
    faqs: [
      ...
      { q: "How much does a crossover permit cost in Brisbane?", a: "The price for a vehicle crossover in Brisbane is confirmed only after we verify the scope on site. Your detailed quote accounts for the finish, final measure, access, excavation, disposal, drainage, pumping, required thickness and reinforcement. Submit the detailed quote form for an itemised written quote." },
  ...
  "pool-surrounds-brisbane": {
    ...
    metaTitle: "Pool Surrounds Brisbane | Exposed Aggregate & Concrete | | Concrete Concepts Group",
    ...
    pricingIntro: "Every project is measured and scoped individually. Your detailed quote confirms the finish, access, excavation, disposal, drainage, pumping, reinforcement, and final measure before work is scheduled.",
    pricingTable: [
      { type: "Plain Concrete (broom finish)", range: "Site-specific quote", est50: "Detailed scope", notes: "Slip-resistant broom texture" },
      { type: "Coloured Concrete", range: "Site-specific quote", est50: "Detailed scope", notes: "Oxide-tinted, multiple colours" },
      { type: "Exposed Aggregate", range: "Site-specific quote", est50: "Detailed scope", notes: "Premium stone, naturally slip-resistant" },
      { type: "Honed Concrete", range: "Site-specific quote", est50: "Detailed scope", notes: "Smooth polished look" },
    ],
    pricingNotes: "A detailed quote is prepared after we verify the final measure, chosen finish, access, excavation, disposal, drainage, pumping, thickness, reinforcement, engineering and any approvals required.",
    comparison: {
      headers: ["Feature", "Concrete", "Pavers", "Timber Decking", "Tiles"],
      rows: [
        { feature: "Quote planning", values: ["Scope and finish verified", "Scope and finish verified", "Scope and finish verified", "Scope and finish verified"] },
    ...
    faqs: [
      ...
      { q: "How much does a concrete pool surround cost in Brisbane?", a: "The price for a pool surround in Brisbane is confirmed only after we verify the scope on site. Your detailed quote accounts for the finish, final measure, access, excavation, disposal, drainage, pumping, required thickness and reinforcement. Submit the detailed quote form for an itemised written quote." },
    ],
  ...
  "shed-slabs-brisbane": {
    ...
    metaTitle: "Shed Slabs Brisbane | Garage Slabs & Foundations | | Concrete Concepts Group",
    ...
    pricingIntro: "Every project is measured and scoped individually. Your detailed quote confirms the finish, access, excavation, disposal, drainage, pumping, reinforcement, and final measure before work is scheduled.",
    pricingTable: [
      { type: "Small Shed Slab (up to 20m²)", range: "Site-specific quote", est50: "Detailed scope", notes: "100mm thick, SL72 mesh" },
      { type: "Standard Garage Slab (30-50m²)", range: "Site-specific quote", est50: "Detailed scope", notes: "100-125mm, SL82 mesh" },
      { type: "Large Shed/Workshop (50-100m²)", range: "Site-specific quote", est50: "Detailed scope", notes: "Engineered design, edge beams" },
      { type: "Granny Flat Slab (40-60m²)", range: "Site-specific quote", est50: "Detailed scope", notes: "Full engineering, plumbing included" },
    ],
    pricingNotes: "A detailed quote is prepared after we verify the final measure, chosen finish, access, excavation, disposal, drainage, pumping, thickness, reinforcement, engineering and any approvals required.",
    faqs: [
      ...
      { q: "How much does a shed slab cost in Brisbane?", a: "The price for a shed slab in Brisbane is confirmed only after we verify the scope on site. Your detailed quote accounts for the finish, final measure, access, excavation, disposal, drainage, pumping, required thickness and reinforcement. Submit the detailed quote form for an itemised written quote." },
        ...
        <div className="container">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-2xl sm:text-3xl font-bold text-brand-charcoal mb-8">
              Why Choose Concrete Concepts Group for{" "}
          ...
          <div className="max-w-4xl mx-auto">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-2xl sm:text-3xl font-bold">
                {service.title} <span className="text-brand-gold italic">Quote Planning</span>
              </h2>
            </div>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-white/10">
                    ...
                    <th className="text-left py-3 px-4 text-brand-gold font-semibold" style={{ fontFamily: "var(--font-body)" }}>Quote Approach</th>
                    <th className="text-left py-3 px-4 text-brand-gold font-semibold" style={{ fontFamily: "var(--font-body)" }}>What We Confirm</th>
